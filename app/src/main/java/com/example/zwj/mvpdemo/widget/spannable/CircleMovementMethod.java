package com.example.zwj.mvpdemo.widget.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = DemoApplication.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = DemoApplication.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
