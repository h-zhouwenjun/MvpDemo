...
import com.example.zwj.mvpdemo.bean.DynamicPhotoBean;
...
public class MultiImageView extends LinearLayout {
	...
	// 照片的Url列表
	private List<DynamicPhotoBean> imagesList;

	/** 长度 单位为Pixel **/
	private int pxOneMaxWandH;  // 单张图最大允许宽高
	private int pxMoreWandH = 0;// 多张图的宽高
	private int pxImagePadding = DensityUtils.dip2px(getContext(), 3);// 图片间的间距
	...
	public void setList(List<DynamicPhotoBean> lists) throws IllegalArgumentException{
		if(lists==null){
	...
	private ImageView createImageView(int position, final boolean isMultiImage) {
		DynamicPhotoBean photoInfo = imagesList.get(position);
