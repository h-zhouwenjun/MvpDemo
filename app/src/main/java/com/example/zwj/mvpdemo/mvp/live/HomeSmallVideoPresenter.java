...
public class HomeSmallVideoPresenter extends BasePresenter<HomeSmallVideoContact.View> {

    @Inject
    public HomeSmallVideoPresenter(HomeSmallVideoContact.View rootView) {
        super(rootView);
    }
